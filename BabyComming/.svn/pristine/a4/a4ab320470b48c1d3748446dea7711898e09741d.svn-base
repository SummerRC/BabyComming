...
public class NurseMaidPersonalActivity extends BaseActiviry implements OnItemClickListener, OnRefreshListener<ScrollView>{
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
//		MyActivityManager.getInstance().addActivity(NurseMaidPersonalActivity.this);
		mFlag = true;
	...
	public void onClick(View view){
		...
		case R.id.ib_collect:
			if(mUser == null){
				mIntent = new Intent(NurseMaidPersonalActivity.this, LoginActivity.class);
		...
		IUpdateUI ui = new IUpdateUI() {
			...
			public void updata(Object allData) {
				...
				if(mNurseDetaisBean.getCode().equals("0") && 
					...
					mTextQwPrice.setText(mNurseDetaisBean.getList().get(0).getPrice()+"/月");
	...
	private void initDataCollect(String userid, String yuesao_id){
		IUpdateUI ui = new IUpdateUI() {
			...
			public void updata(Object allData) {
				// TODO Auto-generated method stub
				if(allData == null){
					Toast.makeText(NurseMaidPersonalActivity.this, 
