...
import com.aohuan.utils.common.SDCardUtils;
...
public class Morefragment extends Fragment implements OnClickListener{
	...
	private void initView(){
		mLayoutClear = (RelativeLayout) getView().findViewById(R.id.clear_huancun);
		...
		mTextClear = (TextView) getView().findViewById(R.id.huancun);
	...
	public void onStart() {
		...
		mTextClear.setText(SDCardUtils.getTempImgFileSize());
		if (user == null) {
