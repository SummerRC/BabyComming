...
public class StoreIntroActivity extends BaseActiviry implements OnItemClickListener, OnRefreshListener<ScrollView> {
	...
	private void loadData() {
		...
		}, false, RequestBaseMap.getStoreDetail(partner_id,page+""));
		...
		mAdapter=new CommonAdapter<GoodsList2>(StoreIntroActivity.this, mList,
			...
			public void convert(ViewHolder helper, GoodsList2 item) {
				...
				helper.setImageByUrl(R.id.photo_goods_image,
				 item.getImage(), StoreIntroActivity.this);
			}
		};
